import type { Vector3, Vector4 } from "../vec/index"
...
export function calcSurfacePoint(p: number, q: number, U: number[], V: number[], P: Vector4[][], u: number, v: number, target: Vector3): void
