...
import { SymbolTypeIdentifier } from "@grx/artwork-format/types"
import {
  type CstNode,
...
interface GerberParseResult {
  image: Shapes.Shape[]
  errors: string[]
}

export function parse(file: string): GerberParseResult {
