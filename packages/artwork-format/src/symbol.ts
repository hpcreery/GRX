...
import { type AttributesType, type ISymbolRecord, SymbolTypeIdentifier, toMap, type Units } from "./types"
...
export class OctagonSymbol extends StandardSymbol {
  constructor(
    symbol: Pick<TStandardSymbol, "width" | "height" | "corner_radius" | "inner_dia"> &
      Partial<{ id: string; units: Units; attributes: AttributesType }>,
  ) {
...
export class RoundedSquareDonutSymbol extends StandardSymbol {
  constructor(
    symbol: Pick<TStandardSymbol, "outer_dia" | "inner_dia" | "corner_radius" | "corners"> &
      Partial<{ id: string; units: Units; attributes: AttributesType }>,
  ) {
...
export class HorizontalHexagonSymbol extends StandardSymbol {
  constructor(
    symbol: Pick<TStandardSymbol, "width" | "height" | "corner_radius"> & Partial<{ id: string; units: Units; attributes: AttributesType }>,
  ) {
