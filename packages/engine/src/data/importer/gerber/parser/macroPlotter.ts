...
import type { MacroPrimitiveCode, MacroValue } from "./types"
import {
  MACRO_CENTER_LINE,
  MACRO_CIRCLE,
...
import type { MacroTool } from "./types"

type VariableValues = Record<string, number>
type Position = [x: number, y: number]

// Helper function: Rotate and shift point
function rotateAndShift(point: Position, shift: Position, degrees = 0): Position {
...
const rotate = (p: Position, angle: number): Position => rotateAndShift(p, [0, 0], angle)
